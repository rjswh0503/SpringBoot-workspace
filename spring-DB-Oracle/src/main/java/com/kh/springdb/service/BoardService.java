...
public class BoardService {
	...
	//게시판에서 게시물 전체보기 Serivce
	public List<Board> getAllBoards(){
		return boardMapper.getAllBoards();
	}
	
	//게시물 1개 선택 했을 때 1가지에 대한 상세보기 Serivce
...
/*
 @Transactional
 	트랜젝션을 지원하는 스프링에서 데이터베이스 관리를 단순히 어노테이션을 사용해서 여러개의 데이터베이스 조작 작업을 
 	묶어서 하나의 작업 단위로 처리하는데 사용하며, 
